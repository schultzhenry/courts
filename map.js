...
// Guam
svg.append('rect').attrs({class: "map-item", id: 91, x: 240, y: 330, width: rectWidth, height: rectHeight});

// Northern Mariana Islands
svg.append('rect').attrs({class: "map-item", id: 92, x: 240, y: 300, width: rectWidth, height: rectHeight});

// Puerto Rico
svg.append('rect').attrs({class: "map-item", id: 93, x: 510, y: 362, width: rectWidth, height: rectHeight});

// Virgin Islands
svg.append('rect').attrs({class: "map-item", id: 94, x: 550, y: 362, width: rectWidth, height: rectHeight});
